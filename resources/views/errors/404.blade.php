...
<head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <title> Demo Deadlink 404 Page Not found Mobile web Template</title>
...
<div id="wrap" style="margin-top: 0px; position: relative;">
    ...
    <div id="topBar">
        <div class="wrap">
            <div class="logo"><a href="/"><img src="images/logo.png" alt="W3layouts.com free mobile website templates"></a></div>
            <div class="right">
                <div class="devices">
                    <ul>
                        ...
                        <li><a href="/preview/?d=smartphone&l=/deadlink-404-free-web-and-mobile-website-template/&o=var"><img src="images/iphone-icon.png" alt=""></a></li>
                        <li><a href="/preview/?d=smartphone&l=/deadlink-404-free-web-and-mobile-website-template/&o=land"><img src="images/iphone-landscape.png" alt=""></a></li>
                        <li><a href="/preview/?d=mobile&l=/deadlink-404-free-web-and-mobile-website-template/"><img src="images/nokia-icon.png" alt=""></a></li>
                    </ul>
                </div>
                <!--<div class="social">
                    <ul>
                ...
                <div class="go-back">
                    <a href="/deadlink-404-free-web-and-mobile-website-template/">Download Template</a>
                </div>
                <a id="close-button" title="Remove Frame" class="closeMe" href="https://p.w3layouts.com/demos/deadlink-404/web" target="_blank"></a>
            </div>
...
<div style="" id="device">
    <iframe id="hw" class="web" src="https://p.w3layouts.com/demos/deadlink-404/web" name="livePreviewFrame" width="100%" height="100%" frameborder="0" noresize="noresize" style=" min-height: 100%;"> </iframe>
</div>
<script>
