            ...
            <div class="col-sm-9">
                ...
                <div class="detail-page-style">
                    ...
                    <div class="offre-slide-arrow">
                        <div class="item">
                            <img src="{{ asset('offers_img/'.$offer->image1) }}" style="width: 120px; height: 80px;" alt="">
                        </div>

                        <div class="item">
                            <img src="{{ asset('offers_img/'.$offer->image2) }}" style="width: 120px; height: 80px;" alt="">
                        </div>

                        <div class="item">
                            <img src="{{ asset('offers_img/'.$offer->image3 ) }}" style="width: 120px; height: 80px;" alt="">
                        </div>
                    </div>
