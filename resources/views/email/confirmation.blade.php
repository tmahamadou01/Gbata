                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0" style="max-width: 100%;">
                                                                    <tr>
                                                                        <td align="left" class="textContent">
                                                                            <h3 style="color:#5F5F5F;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">
                                                                            ...
                                                                            <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">
                                                                                ...
                                                                                <h1 style="line-height: 1em;">Merci d'avoir crée un compte GBATA</h1>

                                                                                <br>
                                                                                <p>
                                                                                    Pour continuer votre navigation sur GBATA veuillez confirmer votre compte
                                                                                </p>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" width="50%" class="emailButton" style="background-color: #3498DB;">
                                                        <tr>
                                                            <td align="center" valign="middle" class="buttonContent" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;">
                                                                <a href="{{ url("register/confirm/{$user->token}") }}" style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%;" target="_blank">Confirmation</a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <!-- // CONTENT TABLE -->
                                                        ...
                                                        <tr>
                                                            <td valign="top" bgcolor="#E1E1E1">
                                                                ...
                                                                <div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
                                                                    <div>Copyright &#169; 2017 - GBATA.ci <a href="http://www.gbata.ci" target="_blank" style="text-decoration:none;color:#828282;">. All&nbsp;rights&nbsp;reserved.</div>
                                                                </div>
